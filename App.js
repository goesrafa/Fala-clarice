  ...
  return (
    <SafeAreaView style={styles.Principal}>
      <Text style={styles.Titulo}>
        <FontAwesome name="comments-o" size={50} color="#8A2BE2" />&nbsp;
        Fala Clarice!
      </Text>
      <Image source={clarice} style={styles.Imagem}></Image>

      {falando && <ActivityIndicator size='large' color="#4B0082" />}

      <FontAwesome.Button
        name="volume-up"
        backgroundColor="#9370DB"
        style={styles.Botao}
        onPress={falar}>Ouvir Frase
      </FontAwesome.Button>

      <FontAwesome.Button
        name="stop-circle"
        onPress={parar}
        backgroundColor={!falando ? "#778899": "#4B0082"}
        disabled={!falando}
